%% Function-based unit test for frac_tf nyquist method
% Last revision 24/09/2021

function tests = test_frac_tf_nyquist
...
%% Function call without frequency band
    ...
    verifyWarning(testCase,@() nyquist(ftf0),'CRONE:sys_empty');
    
    [mag,phi,w_out,h_fig,h_axes]=nyquist(ftf1);
    ...
    [mag,phi,w_out,h_fig,h_axes]=nyquist(ftf2);
    assertFalse(testCase,isempty(mag),'mag is empty');
    assertFalse(testCase,isempty(phi),'phi is empty');
    assertFalse(testCase,isempty(w_out),'w_out is empty');
    assertFalse(testCase,isempty(h_fig),'h_fig is empty');
...
%% Function call with frequency band
    ...
    [mag,phi,w_out,h_fig,h_axes]=nyquist(ftf1,w);
    assertFalse(testCase,isempty(mag),'mag is empty');
    assertFalse(testCase,isempty(phi),'phi is empty');
    assertFalse(testCase,isempty(w_out),'w_out is empty');
    assertFalse(testCase,isempty(h_fig),'h_fig is empty');
    ...
    [mag,phi,w_out,h_fig,h_axes]=nyquist(ftf2,w);
    assertFalse(testCase,isempty(mag),'mag is empty');
    assertFalse(testCase,isempty(phi),'phi is empty');
    assertFalse(testCase,isempty(w_out),'w_out is empty');
    assertFalse(testCase,isempty(h_fig),'h_fig is empty');
...
%% Mimo system
    ...
    [mag,phi,w_out,h_fig,h_axes]=nyquist(sys,w);
    assertFalse(testCase,isempty(mag),'mag is empty');
    assertFalse(testCase,isempty(phi),'phi is empty');
    assertFalse(testCase,isempty(w_out),'w_out is empty');
    assertFalse(testCase,isempty(h_fig),'h_fig is empty');
