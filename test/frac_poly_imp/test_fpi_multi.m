...
%% Function-based unit test for frac_fpi_multi
% Last revision 30/09/2021

function tests = test_fpi_multi
...
pol1=frac_poly_imp([1,2,1],[3,2,0], 1);
pol2=frac_poly_imp([1,1,4],[4,3,0], 1);
pol3=frac_poly_imp([1,2],[2,1], 1);
pol4=frac_poly_imp([6,4],[2,0], 1);
pol5=frac_poly_imp([pol1; pol2]);
pol6=frac_poly_imp([pol3; pol4]);
poly = frac_poly_imp([pol5, pol6]);
